...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few negative numbers") {
    assert(sum(List(-42,-56,-3)) === -101)
  }
  
  test("sum of a few mixed numbers") {
    assert(sum(List(-42,-56,-3, 0, 42, 100)) === 41)
  }
  ...
  test("max of a few negative numbers") {
    assert(max(List(-42,-56,-3)) === -3)
  }
  
  test("max of a few mixed numbers") {
    assert(max(List(-42,-56,-3, 0, 42, 100)) === 100)
  }
}
